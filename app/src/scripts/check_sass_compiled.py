...
def main():
    # Path configuration
    scss_dir = "app/src/scss"
    css_file = "app/src/static/style.css"

    # Check if CSS file exists
    if not os.path.exists(css_file):
        print(
            f"Error: CSS file {css_file} does not exist. "
            "Run 'pysassc app/src/scss/main.scss app/src/static/style.css' to generate it."
        )
        return 1
    ...
    if scss_latest > css_time:
        ...
        print("Run 'pysassc app/src/scss/main.scss app/src/static/style.css' to compile SASS to CSS.")
        return 1
