...
from clients.base import APIError, BaseClient, ClientRequest
...
class DesktopConfigurationsClient(BaseClient):
    ...
    def list_configurations(self, token: str | None = None) -> list[dict]:
    ...
    def get_users(self, token: str | None = None) -> dict:
    ...
    def get_connections(self, token: str | None = None) -> dict:
