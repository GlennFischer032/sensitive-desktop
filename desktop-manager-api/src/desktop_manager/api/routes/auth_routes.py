...
def register():
    ...
    try:
        ...
        db_session.rollback()
        return jsonify({'error': 'Failed to authenticate with Guacamole API', 'details': str(e)}), 500
    ...
    try:
        ...
        return jsonify({'error': 'Failed to assign user to group in Guacamole', 'details': str(e)}), 500
